...
<div id="password-success" class="hidden">
	...
	<div  class="fixed bottom-0 left-0 z-[999] flex w-full justify-between border-t-[10px] border-t-[#14141480] bg-white px-20 py-[25px] lg:items-center">
		<div class="flex gap-x-[12px]">
			...
			<h1 class="w-full max-w-[432px] font-geova text-[14px] font-bold leading-[120%] text-ada_red-50 md:text-[16px] lg:max-w-none lg:text-[18px]">Your password has been successfully updated. Please log in.</h1>
		</div>
