...
<div class="values-section m-0 p-0 lg:pb-10 md:pb-0 pb-[180px]">
	<header
		class="values-header relative text-white lg:py-20 md:py-[60px] py-10 text-center lg:min-h-[585px] md:min-h-[483px] overflow-hidden px-6 md:px-8 lg:px-10 xl:px-20	">
		...
		<div class="header-content relative mx-auto lg:max-w-[924px] md:max-w-[600px]">
			...
			<?php if ( $heading ) : ?>
				<h2
					class="mb-4 lg:text-[32px] uppercase font-medium lg:leading-[40px] lg:tracking-[-0.25px] md:text-[24px] md:leading-[31px] text-[20px] leading-[28px] ">
	...
	<?php if ( $tiles ) : ?>
		<section class="tiles-container relative max-h-[467px] h-full px-6 md:px-8 lg:px-10 xl:px-20">
			<div
				class="tiles flex md:flex-row flex-col justify-center md:pt-[60px] gap-6 mx-auto lg:max-w-[924px] lg:-translate-y-[280px] md:-translate-y-[175px]">
