<?php
/**
 * Firstfold functions and definitions
 *
...
function firstfold_setup() {
	...
	register_nav_menus(
		array(
			...
			// Demo Menu.
			'stacked-flyout-menu'    => esc_html__( 'With stacked flyout menu', 'firstfold' ),
			'constrained'            => esc_html__( 'Constrained', 'firstfold' ),
			'full-width-flyout-menu' => esc_html__( 'Full width flyout menu', 'firstfold' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'firstfold_custom_background_args',
			array(
